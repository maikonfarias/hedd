...
lib.classes["ROGUE"][2] = function()
	...
	lib.AddSpell("RS",{84617}) -- Revealing Strike
	lib.AddAura("RS",84617,"debuff","target") -- Revealing Strike
	cfg.gcd_spell = "SS"
	...
	table.insert(cfg.plistdps,"AR")
	table.insert(cfg.plistdps,"KS")
	table.insert(cfg.plistdps,"RS_noRS")
...
--[[	function Heddclassevents:UNIT_COMBO_POINTS()
	...
	lib.OnShape=lib.UpdateAllSpells
	
	lib.CD = function()
		lib.CDadd("Kick")
		lib.CDadd("Recuperate")
		lib.CDadd("Premeditation")
		lib.CDadd("Shadow Dance")
		lib.CDadd("Shadow Reflection")
		lib.CDadd("Vanish")
		lib.CDadd("Preparation")
		lib.CDadd("AR")
		lib.CDadd("KS")
	end
